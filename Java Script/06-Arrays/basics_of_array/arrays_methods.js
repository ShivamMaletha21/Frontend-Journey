...
//5. slice() -> creates copy of part of an array, the original array remains unchanged.. syntax -> array.slice(start,end); the element at the end is not included
...
//6. splice() -> add, remove or replace element at any position , the original array changes, syntax ->array.splice(start,deleteCount,items);
